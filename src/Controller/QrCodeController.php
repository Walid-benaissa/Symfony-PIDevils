...
{
    #[Route('/qr-codes/{idVehicule}', name: 'app_qr_codes', methods: ['GET'])]
public function index(int $idVehicule,UrlGeneratorInterface $urlGenerator,EntityManagerInterface $em): Response
{
    ...
    $qrCode = QrCode::create(
        sprintf(
            ...
            $reservationUrl = $urlGenerator->generate('app_location_new', ['idVehicule'=>$vehicule->getId()], UrlGeneratorInterface::ABSOLUTE_URL)
        )
